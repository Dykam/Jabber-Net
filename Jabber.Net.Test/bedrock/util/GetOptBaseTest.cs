...
namespace test.bedrock.util
{
    ...
    public class GetOptTest
    {
        ...
        {
            Assert.That(() => new TestGetOpt(new string[] {"/some", "one"}), Throws.InstanceOf<FormatException>());
        }
        [Test] public void Test_Error()
        {
            Assert.That(() => new TestGetOpt(new string[] {"/broncos"}), Throws.ArgumentException);
        }
