...
using Factory = Jabber.protocol.accept.Factory;
...
namespace Jabber.server
{
    ...
    /// </summary>
    public delegate void RouteHandler(object sender, Route route);

    /// <summary>
    /// Received an XDB element.
    /// </summary>
    public delegate void XdbHandler(object sender, Xdb xdb);

    /// <summary>
    /// Received a Log element.
    /// </summary>
    public delegate void LogHandler(object sender, Log log);

    /// <summary>
    /// Summary description for ServerComponent.
    /// </summary>
    [SVN(@"$Id$")]
    public class JabberService : XmppStream
    {
        ...
        private void init()
        {
            ...
            this.OnStreamInit += new StreamHandler(JabberService_OnStreamInit);
            this.OnSASLStart += new SASLProcessorHandler(JabberService_OnSASLStart);
        }
        ...
        protected override void OnDocumentStart(object sender, System.Xml.XmlElement tag)
        {
            ...
            if (this.Type == ComponentType.Connect)
            {
                ...
                Stream str = new Stream(this.Document, NS);
    ...
    /// </summary>
    [SVN(@"$Id$")]
    public class HandshakingState : BaseState
    {
        /// <summary>
        /// The instance that is always used.
        /// </summary>
        public static readonly BaseState Instance = new HandshakingState();
    }
