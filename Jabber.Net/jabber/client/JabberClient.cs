...
using Auth = Jabber.protocol.iq.Auth;
using Error = Jabber.protocol.client.Error;
using Factory = Jabber.protocol.client.Factory;
...
namespace Jabber.client
{
    ...
    public class JabberClient : XmppStream
    {
        ...
        private void init()
        {
            ...
            this.OnSASLStart += new SASLProcessorHandler(JabberClient_OnSASLStart);
            this.OnSASLEnd += new FeaturesHandler(JabberClient_OnSASLEnd);
 ...
 */
        ...
        private void OnGetRegister(object sender, IQ iq, object data)
        {
            ...
            else if (iq.Type == IQType.result)
            {
                ...
                Data xdata = r["x", URI.XDATA] as Data;
                Field f;
                if (xdata != null)
                {
        ...
        private void GotResource(object sender, IQ iq, object state)
        {
            ...
            if (feat["session", URI.SESSION] != null)
            {
                ...
                iqs.Type = IQType.set;
                iqs.AddChild(new Session(this.Document));
    ...
    /// </summary>
    [SVN(@"$Id: JabberClient.cs 724 2008-08-06 18:09:25Z hildjj $")]
    public class GetAuthState : BaseState
    {
        /// <summary>
        /// Gets the instance that is always used.
        /// </summary>
        public static readonly BaseState Instance = new GetAuthState();
    }
    ...
    /// </summary>
    [SVN(@"$Id: JabberClient.cs 724 2008-08-06 18:09:25Z hildjj $")]
    public class SetAuthState : BaseState
    {
        /// <summary>
        /// Gets the instance that is always used.
        /// </summary>
        public static readonly BaseState Instance = new SetAuthState();
    }
    ...
    /// </summary>
    [SVN(@"$Id: JabberClient.cs 724 2008-08-06 18:09:25Z hildjj $")]
    public class ManualLoginState : BaseState
    {
        /// <summary>
        /// Gets the instance that is always used.
        /// </summary>
        public static readonly BaseState Instance = new ManualLoginState();
    }
    ...
    /// </summary>
    [SVN(@"$Id: JabberClient.cs 724 2008-08-06 18:09:25Z hildjj $")]
    public class ManualSASLLoginState : BaseState
    {
        /// <summary>
        /// Gets the instance that is always used.
        /// </summary>
        public static readonly BaseState Instance = new ManualSASLLoginState();
    }
