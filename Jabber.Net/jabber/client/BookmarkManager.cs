...
namespace Jabber.client
{
    ...
    /// </summary>
    [SVN(@"$Id$")]    
    public class BookmarkManager : StreamComponent
	{
        ...
        public ConferenceManager ConferenceManager
        {
            get
            {
                ...
                if ((m_confManager == null) && DesignMode)
                {
                    ...
                    this.ConferenceManager = (ConferenceManager)StreamComponent.GetComponentFromHost(host, typeof(ConferenceManager));
                }
