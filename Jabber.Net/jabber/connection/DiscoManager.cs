        ...
        private void RequestInfo(DiscoNode node)
        {
            lock (node)
            {
                if (!node.PendingInfo)
                {
                    ...
                    JabberService js = m_stream as JabberService;
                    if (js != null)
                        iq.From = js.ComponentID;
                    BeginIQ(iq, new IqCB(GotInfo), node);
                }
            }
        }
        ...
        private void RequestItems(DiscoNode node)
        {
            lock (node)
            {
                if (!node.PendingItems)
                {
                    ...
                    if (js != null)
                        iq.From = js.ComponentID;
                    BeginIQ(iq, new IqCB(GotItems), node);
                }
            }
        }
                ...
                if (dn == m_root)
                {
                    ...
                    if (err != null)
                    {
                            ...
                            (cond == Error.SERVICE_UNAVAILABLE))
                        {
                            ...
                            BeginIQ(aiq, new IqCB(GotAgents), m_root);
                            return;
                        }
                    }
                }
