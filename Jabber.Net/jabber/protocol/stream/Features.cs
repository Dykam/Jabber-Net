...
namespace Jabber.protocol.stream
{
    ...
    public class Features : Element
    {
        ...
        public Features(XmlDocument doc) :
            base("stream", new XmlQualifiedName("features", URI.STREAM), doc)
        {
        }
        ...
        {
            get { return this["starttls", URI.START_TLS] as StartTLS; }
        ...
        {
            get { return this["mechanisms", URI.SASL] as Mechanisms; }
            set { ReplaceChild(value); }
        }
        ...
        {
            get { return this["compression", URI.COMPRESS_FEATURE] as Compression; }
        }
    }
}
