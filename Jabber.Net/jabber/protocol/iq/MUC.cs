...
#region base protocol
    ...
    /// </summary>
    [SVN(@"$Id$")]
    public class RoomPresence : Presence
    {
        /// <summary>
...
#region admin
    ...
    /// </summary>
    [SVN(@"$Id$")]
    public class RoomAdminIQ : TypedIQ<AdminQuery>
    {
        /// <summary>
...
#region owner
    ...
    /// </summary>
    [SVN(@"$Id$")]
    public class OwnerIQ : TypedIQ<OwnerQuery>
    {
        /// <summary>
        /// Create
        /// </summary>
    ...
    public class OwnerQuery : Element
    {
        ...
        public Data Form
        {
            get { return GetOrCreateElement("x", URI.XDATA, typeof(Data)) as Data; }
            set { ReplaceChild(value); }
        }
